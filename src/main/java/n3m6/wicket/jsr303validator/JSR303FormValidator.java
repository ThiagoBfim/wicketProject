...
public class JSR303FormValidator extends AbstractFormValidator {
	 ...
	 * 
	 */
	private class JSR303ValidatorFormComponentVisitor implements IVisitor<FormComponent<?>, Void> {
		...
		public void component(FormComponent<?> formComponent, IVisit<Void> visit) {
			if (formComponent instanceof AbstractTextComponent<?>) {
				...
				if (model.getChainedModel() != null && model.getChainedModel().getObject() != null) {
					...
					component.add(new BeanPropertyValidator(modelObjectClass, model.getPropertyExpression(), groups));
